<div>
    <div class="flex justify-between items-center mb-4">
        ...
        <button wire:click="abrirModalCrear" class="bg-blue-500 text-white px-4 py-2 rounded cursor-pointer">Nuevo Cliente</button>
    </div>
            ...
            <tbody>
                ...
                <tr class="hover:bg-blue-50 {{ $loop->even ? 'bg-gray-50' : '' }}">
                    ...
                    <td class="py-2 px-4 border-b">
                        <button wire:click="abrirModalEditar({{ $cliente->id }})" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded mr-2 text-sm cursor-pointer">Editar</button>
                        <button wire:click="confirmarEliminar({{ $cliente->id }})" class="inline-block bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm cursor-pointer">Eliminar</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
